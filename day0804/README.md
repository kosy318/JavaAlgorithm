...
# 완전 검색 활용 - 주사위 던지기
1. 주사위를 3번 던져서 나올 수 있는 모든 경우
2. 주사위를 3번 던져서 모두 다른 수가 나올 수 있는 모든 경우
3. 주사위를 3번 던진 결과가 다음과 같이 중복 되는 경우를 제외하고 나올 수 있는 모든 경우
4. 주사위를 3번 던져서 모두 다른 수가 나올 수 있는 모든 경우
